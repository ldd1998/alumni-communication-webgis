...
layui.use(['form', 'element', 'util', 'carousel', 'form', 'laypage', 'layer','table','upload'], function () {
    ...
    form.on('submit(demo1)', function(data){
        ...
        //object["username"] = data.field.username;//用户名禁止修改
        object["userid"] = data.field.userid;
        ...
        object["address"] = data.field.address;
        object["workAddress"] = data.field.workAddress;
        object["company"] = data.field.company;
        object["position"] = data.field.position;
        object["sex"] = data.field.sex;
        var jsonData = JSON.stringify(object);
        $.ajax({
            url: basePath + "/admin/updateUserInfoById",
            data: jsonData,
